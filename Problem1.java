...
public class Problem1 {
	...
	public static void main(String[] args) {
		...
		changeDouble(numbers, new Consumer<Integer>() {
			@Override
			public void accept(Integer t) {
				System.out.println(String.format("Double of %d is %d", t, t * 2));
		...
		transformStrings(data, new Function<String,String>() {
			@Override
		...
		printIf(inputs, new IntPredicate() {
